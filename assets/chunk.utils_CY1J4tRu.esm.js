...
var v, g, b = o("url"),
    ...
    U = class {
        constructor({
            ...
            v.set(this, void 0), g.set(this, void 0), i(this, v, e, "f"), i(this, g, t, "f")
        }
        exportMetrics(e, i) {
            return a(this, void 0, void 0, (function*() {
                var a;
                try {
                    yield t(this, v, "f").exportMetrics(e, Object.assign(Object.assign({}, i), {
                        keepalive: t(this, g, "f").call(this)
                    }))
                } catch (t) {
                    if (t instanceof P) {
                        const s = null === (a = t.metadata) || void 0 === a ? void 0 : a.retryAfter;
                        if (s) return void(yield new Promise((t => {
                            setTimeout((() => this.exportMetrics(e, i).finally(t)), 1e3 * s.seconds)
                        })))
                    }
                    throw t
                }
        ...
        exportLogs(e, i) {
            return a(this, void 0, void 0, (function*() {
                var a;
                try {
                    yield t(this, v, "f").exportLogs(e, Object.assign(Object.assign({}, i), {
                        keepalive: t(this, g, "f").call(this)
                    }))
                } catch (t) {
                    if (t instanceof P) {
                        const s = null === (a = t.metadata) || void 0 === a ? void 0 : a.retryAfter;
                        if (s) return void(yield new Promise((t => {
                            setTimeout((() => this.exportLogs(e, i).finally(t)), 1e3 * s.seconds)
                        })))
                    }
                    throw t
                }
...
function O() {
    {
        const t = new N("https://otlp-http-production.shopifysvc.com/v1/metrics", "shop-js");
        return new U({
            exporter: t,
            getKeepalive: () => "readyState" in e && "complete" === e.readyState
        })
    }
}
export {
    j as n, m as r, O as t
};
//# sourceMappingURL=chunk.utils_CY1J4tRu.esm.js.map