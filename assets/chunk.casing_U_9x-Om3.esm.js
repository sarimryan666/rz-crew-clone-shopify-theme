...
function P() {
    for (var e, t, l, o, u, i, s, c = 1; _.length;) _.length > c && _.sort(r), e = _.shift(), c = _.length, e.__d && (l = void 0, o = void 0, u = (o = (t = e).__v).__e, i = [], s = [], t.__P && ((l = v({}, o)).__v = o.__v + 1, n.vnode && n.vnode(l), A(t.__P, l, o, t.__n, t.__P.namespaceURI, 32 & o.__u ? [u] : null, i, null == u ? w(o) : u, !!(32 & o.__u), s), l.__v = o.__v, l.__.__k[l.__i] = l, $(i, l, s), o.__e = o.__ = null, l.__e != u && x(l)));
    P.__r = 0
}
...
function S(e, n, t, _, l, o, r, u, i, s, c) {
    var f, h, d, v, y, m, g, k = _ && _.__k || a,
        b = n.length;
    for (i = U(t, n, k, i, b), f = 0; f < b; f++) null != (d = t.__k[f]) && (h = -1 == d.__i ? p : k[d.__i] || p, d.__i = f, m = A(e, d, h, l, o, r, u, i, s, c), v = d.__e, d.ref && h.ref != d.ref && (h.ref && I(h.ref, null, d), c.push(d.ref, d.__c || v, d)), null == y && null != v && (y = v), (g = !!(4 & d.__u)) || h.__k === d.__k ? i = T(d, i, e, g) : "function" == typeof d.type && void 0 !== m ? i = m : v && (i = v.nextSibling), d.__u &= -7);
    return t.__e = y, i
}
...
function U(e, n, t, _, l) {
    ...
    if (f)
        for (o = 0; o < c; o++) null != (u = t[o]) && !(2 & u.__u) && (u.__e == _ && (_ = w(u)), R(u, u));
    return _
}
...
function A(e, t, _, l, o, r, u, i, s, c) {
    var f, p, a, h, m, g, w, x, C, P, U, T, D, M, E, L, W, A = t.type;
    if (void 0 !== t.constructor) return null;
    128 & _.__u && (s = !!(32 & _.__u), r = [i = t.__e = _.__e]), (f = n.__b) && f(t);
    e: if ("function" == typeof A) try {
        if (x = t.props, C = "prototype" in A && A.prototype.render, P = (f = A.contextType) && l[f.__c], U = f ? P ? P.props.value : f.__ : l, _.__c ? w = (p = t.__c = _.__c).__ = p.__E : (C ? t.__c = p = new A(x, U) : (t.__c = p = new b(x, U), p.constructor = A, p.render = z), P && P.sub(p), p.state || (p.state = {}), p.__n = l, a = p.__d = !0, p.__h = [], p._sb = []), C && null == p.__s && (p.__s = p.state), C && null != A.getDerivedStateFromProps && (p.__s == p.state && (p.__s = v({}, p.__s)), v(p.__s, A.getDerivedStateFromProps(x, p.__s))), h = p.props, m = p.state, p.__v = t, a) C && null == A.getDerivedStateFromProps && null != p.componentWillMount && p.componentWillMount(), C && null != p.componentDidMount && p.__h.push(p.componentDidMount);
        else {
            if (C && null == A.getDerivedStateFromProps && x !== h && null != p.componentWillReceiveProps && p.componentWillReceiveProps(x, U), t.__v == _.__v || !p.__e && null != p.shouldComponentUpdate && !1 === p.shouldComponentUpdate(x, p.__s, U)) {
        ...
        p.state = p.__s, null != p.getChildContext && (l = v(v({}, l), p.getChildContext())), C && !a && null != p.getSnapshotBeforeUpdate && (g = p.getSnapshotBeforeUpdate(h, m)), L = f, null != f && f.type === k && null == f.key && (L = F(f.props.children)), i = S(e, d(L) ? L : [L], t, _, l, o, r, u, i, s, c), p.base = t.__e, t.__u &= -161, p.__h.length && u.push(p), w && (p.__E = p.__ = null)
    } catch (e) {
        if (t.__v = null, s || null != r)
            if (e.then) {
                ...
                for (W = r.length; W--;) y(r[W]);
                N(t)
            }
        else t.__e = _.__e, t.__k = _.__k, e.then || N(t);
        n.__e(e, t, _)
    } else null == r && t.__v == _.__v ? (t.__k = _.__k, t.__e = _.__e) : i = t.__e = H(_.__e, t, _, l, o, r, u, s, c);
    return (f = n.diffed) && f(t), 128 & t.__u ? void 0 : i
}

function N(e) {
    e && e.__c && (e.__c.__e = !0), e && e.__k && e.__k.forEach(N)
}

function $(e, t, _) {
    for (var l = 0; l < _.length; l++) I(_[l], _[++l], _[++l]);
...
function F(e) {
    return "object" != typeof e || null == e || e.__b && e.__b > 0 ? e : d(e) ? e.map(F) : v({}, e)
}

function H(t, _, l, o, r, u, i, s, c) {
    ...
    if (null == C) b === x || s && t.data == x || (t.data = x);
        ...
        for (f in x) m = x[f], "children" == f ? v = m : "dangerouslySetInnerHTML" == f ? a = m : "value" == f ? g = m : "checked" == f ? k = m : s && "function" != typeof m || b[f] === m || L(t, f, m, b[f], r);
        ...
        s || (f = "value", "progress" == C && null == g ? t.removeAttribute("value") : null != g && (g !== t[f] || "progress" == C && !g || "option" == C && g != b[f]) && L(t, f, g, b[f], r), f = "checked", null != k && k != t[f] && L(t, f, k, b[f], r))
    }
    return t
}
...
function R(e, t, _) {
    var l, o;
    if (n.unmount && n.unmount(e), (l = e.ref) && (l.current && l.current != e.__e || I(l, null, t)), null != (l = e.__c)) {
    ...
    if (l = e.__k)
        for (o = 0; o < l.length; o++) l[o] && R(l[o], t, _ || "function" != typeof e.type);
...
function B(t, _, l) {
    var o, r, u, i;
    _ == document && (_ = document.documentElement), n.__ && n.__(t, _), r = (o = "function" == typeof l) ? null : l && l.__k || _.__k, u = [], i = [], A(_, t = (!o && l || _).__k = m(k, null, [t]), r || p, p, _.namespaceURI, !o && l ? [l] : r ? null : _.firstChild ? e.call(_.childNodes) : null, u, !o && l ? l : r ? r.__e : _.firstChild, o, i), $(u, t, i)
}
...
function Z(e) {
    return e.replace(/[-:_]([a-z])/g, ((e, n) => `${n.toUpperCase()}`))
}

function V(e) {
    return e.replace(/([a-z0-9])([A-Z])/g, ((e, n, t) => `${n}-${t.toLowerCase()}`)).replace(/[\s_]+/g, "-")
}
...
e = a.slice, n = {
    ...
    var t = null != this.__s && this.__s != this.state ? this.__s : this.__s = v({}, this.state);
    "function" == typeof e && (e = e(v({}, t), this.props)), e && v(t, e), null != e && this.__v && (n && this._sb.push(n), C(this))
...
}, P.__r = 0, u = /(PointerCapture)$|Capture$/i, i = 0, s = W(!1), c = W(!0), f = 0;
export {
    D as a, m as c, b as d, B as i, k as l, V as n, O as o, q as r, j as s, Z as t, n as u
};
//# sourceMappingURL=chunk.casing_U_9x-Om3.esm.js.map